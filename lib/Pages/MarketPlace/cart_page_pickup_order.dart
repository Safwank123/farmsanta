...
class CartPagePickUpOrder extends BaseScreen {
  final bool isPurchase;
  final int initialIndex;
  const CartPagePickUpOrder(
      {super.key, required this.isPurchase, required this.initialIndex});

  @override
  BaseScreenState<CartPagePickUpOrder> createState() =>
      _CartPagePickUpOrderState();
}

class _CartPagePickUpOrderState extends BaseScreenState<CartPagePickUpOrder>
  ...
  Widget buildWidget(BuildContext context) {
    return Scaffold(
      appBar: AppBarDesigns.getAppTitleOnly(AppStrings.mycart),
      body: Column(
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(controller: tabController, children: [
              tabContentPickupOrder(AppColors.primary),
              tabContentPickupOrder(AppColors.rentalPrimary),
            ]),
          ),
  ...
  Widget tabContentPickupOrder(Color color) {
      ...
      children: [
        Column(
          ...
          children: [
            ...
            10.heightBox,
            CustomText(
              textKey: AppStrings.sharelocationpickupaddress,
              size: 14,
            ).p4(),
            Column(
              children: [
                ...
                10.heightBox,
                CustomText(
                  textKey: AppStrings.storelocationcondition,
                  style: const TextStyle(fontSize: 1),
                  color: color,
                  size: 1,
                )
