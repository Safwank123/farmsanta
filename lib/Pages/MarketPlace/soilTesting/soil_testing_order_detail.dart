...
class SoilTestingOrderDetails extends BaseScreen {
  ...
  BaseScreenState<SoilTestingOrderDetails> createState() =>
      _SoilTestingOrderDetailsState();
}

class _SoilTestingOrderDetailsState
    extends BaseScreenState<SoilTestingOrderDetails> {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  CustomText(
                    size: 18,
                    textKey: "Soil Testing".toUpperCase(),
                    color: AppColors.white,
                  ),
                  ...
                  CustomText(
                    size: 10,
                    textKey: 'Booking ID: ', // TODO: Need to add in model
                    color: AppColors.white,
                  ),
                  ...
                  CustomText(
                    size: 10,
                    textKey: 'Lab Visit Date : 13 April,2023',
                    color: AppColors.white,
                  ),
                  ...
                  deliveryAddressCard(address: "Village Market Road"),
                  ...
                  TextButton(
                          onPressed: () {},
                          child: CustomText(
                            textKey: "Direction on 13 April,2023",
                            color: AppColors.white,
                          ))
                      .w(width)
                      .h(height * 0.05)
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          paymentModeAndIcon(
                              isBold: false,
                              paymentNameColor: AppColors.soilTestPrimary,
                      ...
                      headingValueCard(
                          ...
                          value:
                              "#350 House No.,Village Name, Street Address State, City"),
  ...
  Widget titleIconRowWidget(
    ...
    return Row(
      ...
      children: [
        ...
        // store name
        CustomText(textKey: title, size: 10, color: AppColors.soilTestPrimary)
      ],
    );
  }
